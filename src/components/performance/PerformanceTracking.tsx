          ...
          <div className="border-b border-gray-100 dark:border-gray-700 overflow-x-auto scroll-touch">
            <nav className="-mb-px flex px-6">
              {[
                ...
                >
                  <div className={`mr-2 p-1 rounded-md ${activeTab === tab.key ? 'bg-indigo-50 dark:bg-indigo-900/30' : 'bg-transparent'}`}>
                    <tab.icon className={`h-5 w-5 flex-shrink-0 transition-colors ${activeTab === tab.key ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-400 dark:text-gray-500 group-hover:text-gray-500 dark:group-hover:text-gray-300'}`} />
                  </div>
                  ...
                  <div key={course.id} className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-6 shadow-sm">
                    ...
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <div className="text-right">
                        <div className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">{course.current_day}/{course.total_days}<span className="text-base text-gray-500 dark:text-gray-400 font-normal ml-1">일차</span></div>
                    ...
                    <div className="mb-8">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm font-bold text-indigo-600 dark:text-indigo-400">{course.overall_completion}%</span>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                      {course.daily_progress.map((day) => {
                        ...
                        return (
                          <div
                            key={day.day}
                            className={`border rounded-xl p-4 transition-all shadow-sm ${isCurrentDay ? 'border-indigo-200 dark:border-indigo-800 bg-indigo-50/50 dark:bg-indigo-900/20 ring-1 ring-indigo-200 dark:ring-indigo-800' :
                          ...
                          >
                            <div className="flex items-center justify-between mb-3">
                              <div className="flex items-center space-x-2">
                                <span className={`text-sm font-bold ${isCurrentDay ? 'text-indigo-700 dark:text-indigo-400' :
                                ...
                                {isCurrentDay && <Clock className="h-4 w-4 text-indigo-600 dark:text-indigo-400" />}
                  ...
                  <div className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-6 shadow-sm">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                        ...
                        <span className="text-indigo-600 dark:text-indigo-400 font-bold">{Math.round((overallStats.excellent / overallStats.total_trainees) * 100)}%</span>
                      </div>
                      <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                        <span className="text-gray-900 dark:text-white font-bold">양호 ({overallStats.good}명)</span>
                        <span className="text-indigo-600 dark:text-indigo-400 font-bold">{Math.round((overallStats.good / overallStats.total_trainees) * 100)}%</span>
                      </div>
                      <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                        <span className="text-gray-900 dark:text-white font-bold">개선 필요 ({overallStats.needs_improvement}명)</span>
                        <span className="text-indigo-600 dark:text-indigo-400 font-bold">{Math.round((overallStats.needs_improvement / overallStats.total_trainees) * 100)}%</span>
                      </div>
                    </div>
                  </div>
                        ...
                        return (
                          <div key={course}>
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <span className="text-indigo-600 dark:text-indigo-400 font-bold">{avgScore}점</span>
                            </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-3">
                    <input
                      type="text"
                      placeholder="수강생 검색..."
                      className="border border-gray-200 dark:border-gray-600 rounded-xl px-4 py-2 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
                    />
                    <select className="border border-gray-200 dark:border-gray-600 rounded-xl px-4 py-2 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
            ...
            {activeTab === 'reports' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="border border-gray-100 dark:border-gray-700 rounded-2xl p-6 hover:shadow-md transition-all bg-white dark:bg-gray-800 group cursor-pointer">
                    <h4 className="font-bold text-gray-900 dark:text-white mb-2 flex items-center group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
                  ...
                  <div className="border border-gray-100 dark:border-gray-700 rounded-2xl p-6 hover:shadow-md transition-all bg-white dark:bg-gray-800 group cursor-pointer">
                    <h4 className="font-bold text-gray-900 dark:text-white mb-2 flex items-center group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
                      <BookOpen className="w-5 h-5 mr-2 text-indigo-500 dark:text-indigo-400" />
                      과정별 분석 리포트
                    </h4>
