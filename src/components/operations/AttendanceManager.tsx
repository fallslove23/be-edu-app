        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white dark:bg-gray-800 rounded-[2rem] shadow-sm border border-gray-100 dark:border-gray-700 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-bold text-gray-500 dark:text-gray-400">평균 출석률</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-[2rem] shadow-sm border border-gray-100 dark:border-gray-700 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-bold text-gray-500 dark:text-gray-400">총 세션 수</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-[2rem] shadow-sm border border-gray-100 dark:border-gray-700 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-bold text-gray-500 dark:text-gray-400">총 교육생</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-[2rem] shadow-sm border border-gray-100 dark:border-gray-700 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-bold text-gray-500 dark:text-gray-400">오늘 세션</p>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                ...
                <span className="font-bold text-blue-600 dark:text-blue-400"> 출석 관리 페이지</span>에서 이용하실 수 있습니다.
              </p>
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-600 dark:text-gray-400 mb-6">
                <li className="flex items-center p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl font-medium">
              ...
              <button
                onClick={() => router.push('/attendance')}
                className="bg-gray-900 hover:bg-gray-800 dark:bg-gray-700 dark:hover:bg-gray-600 text-white px-6 py-3 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all inline-flex items-center space-x-2"
              >
                <span>출석 관리로 이동</span>
                <ArrowRight className="h-4 w-4" />
              </button>
