    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/30 dark:to-pink-900/30">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">시험 복제 마법사</h2>
            ...
            {[1, 2, 3].map((s) => (
              <React.Fragment key={s}>
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-sm font-medium ${step >= s ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400'}`}>
                    {s === 1 && '기본 정보'}
                    {s === 2 && '복제 옵션'}
                    {s === 3 && '일정 설정'}
                  </span>
                ...
                {s < 3 && (
                  <div
                    className={`flex-1 h-0.5 mx-2 ${step > s ? 'bg-green-500' : 'bg-gray-200 dark:bg-gray-700'
                      }`}
                  />
                )}
              </React.Fragment>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {step === 1 && (
            <div className="space-y-6 animate-fade-in">
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <h3 className="font-semibold text-blue-900 dark:text-blue-300 mb-2">원본 시험 정보</h3>
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <div><span className="text-blue-700 dark:text-blue-400">유형:</span> <span className="font-medium text-gray-900 dark:text-gray-200">{exam.exam_type}</span></div>
                  <div><span className="text-blue-700 dark:text-blue-400">시간:</span> <span className="font-medium text-gray-900 dark:text-gray-200">{exam.duration_minutes}분</span></div>
                  <div><span className="text-blue-700 dark:text-blue-400">합격점:</span> <span className="font-medium text-gray-900 dark:text-gray-200">{exam.passing_score}점</span></div>
                  <div><span className="text-blue-700 dark:text-blue-400">최대 응시:</span> <span className="font-medium text-gray-900 dark:text-gray-200">{exam.max_attempts}회</span></div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 dark:border-gray-600 rounded-full px-3 py-2 focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                    min="1"
                  />
                </div>
                <div>
            ...
            <div className="space-y-6 animate-fade-in">
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/30 dark:to-pink-900/30 rounded-lg p-4 border border-purple-200 dark:border-purple-800">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-purple-900 dark:text-purple-300 mb-1">스마트 복제 옵션</h3>
              ...
              <div className="space-y-4">
                {/* 문제 섞기 */}
                <label className="flex items-center gap-3 p-4 border-2 border-gray-200 dark:border-gray-700 rounded-full hover:border-purple-300 dark:hover:border-purple-500 cursor-pointer transition-all">
                  <input
                    type="checkbox"
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium text-gray-900 dark:text-white">문제 순서 섞기</span>
                    </div>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                ...
                <label className="flex items-center gap-3 p-4 border-2 border-gray-200 dark:border-gray-700 rounded-full hover:border-purple-300 dark:hover:border-purple-500 cursor-pointer transition-all">
                  ...
                  />
                  <div className="flex-1">
                    <span className="font-medium text-gray-900 dark:text-white">문제 랜덤 출제</span>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                ...
                <label className="flex items-center gap-3 p-4 border-2 border-gray-200 dark:border-gray-700 rounded-full hover:border-purple-300 dark:hover:border-purple-500 cursor-pointer transition-all">
                  ...
                  />
                  <div className="flex-1">
                    <span className="font-medium text-gray-900 dark:text-white">정답 표시</span>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                      시험 완료 후 정답을 표시합니다
                    </p>
                  </div>
          ...
          {step === 3 && (
            <div className="space-y-6 animate-fade-in">
              <div className="bg-green-500/10 dark:bg-green-500/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  <CalendarIcon className="h-6 w-6 text-green-600 dark:text-green-400 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-semibold text-green-900 dark:text-green-300 mb-1">일정 자동 조정</h3>
              ...
              {exam.scheduled_at && (
                <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                  <div className="text-sm text-gray-600 dark:text-gray-400 mb-1">원본 시험 일정</div>
              ...
              <label className="flex items-center gap-3 p-4 border-2 border-gray-200 dark:border-gray-700 rounded-full hover:border-green-300 dark:hover:border-green-500 cursor-pointer transition-all">
                <input
                  type="checkbox"
                ...
                />
                <div className="flex-1">
                  <span className="font-medium text-gray-900 dark:text-white">일정 자동 조정</span>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              ...
              {options.adjustSchedule && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 dark:border-gray-600 rounded-full px-3 py-2 focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                    min="0"
                  />
                  ...
                  {exam.scheduled_at && options.daysOffset !== undefined && (
                    <div className="mt-3 p-3 bg-green-500/10 dark:bg-green-500/20 rounded border border-green-200 dark:border-green-800">
                      <div className="text-xs text-green-700 dark:text-green-400 mb-1">새로운 일정</div>
