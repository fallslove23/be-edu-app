    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <button className="p-4 bg-indigo-50 rounded-lg border border-indigo-200 hover:bg-indigo-100 transition-colors text-center">
            <div className="text-2xl mb-2">💬</div>
            <div className="font-medium text-indigo-900">실시간 채팅</div>
            <div className="text-sm text-indigo-700">소통하기</div>
          </button>
        </div>
      </div>
