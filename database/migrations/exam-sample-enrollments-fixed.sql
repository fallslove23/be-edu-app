...
-- ========================================
-- 2. course_id 제약 조건 임시 제거 (필요한 경우)
-- ========================================

-- course_id가 NOT NULL이면 임시로 NULL 허용으로 변경
DO $$
BEGIN
    IF EXISTS (
        SELECT 1
        ...
        RAISE NOTICE 'course_id NOT NULL 제약 조건 제거됨';
    END IF;
END $$;

-- ========================================
-- 3. 교육생 등록 (course_enrollments)
-- ========================================
