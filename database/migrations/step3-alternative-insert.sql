-- STEP 3 대안: UUID를 직접 생성하여 테스트 데이터 삽입
...
-- 테스트용 사용자 데이터 삽입 (gen_random_uuid() 사용)
INSERT INTO public.users (id, name, email, role, department) 
VALUES 
(gen_random_uuid(), '홍길동', 'hong@example.com', 'trainee', '영업팀'),
(gen_random_uuid(), '김영희', 'kim@example.com', 'trainee', '마케팅팀'),
(gen_random_uuid(), '관리자', 'admin@example.com', 'admin', '관리팀')
